...
if ( ! function_exists('thePostThumbnail')) {
    function thePostThumbnail($image,$alt='',$width = '',$height= '',$class='',$crop=true,$qlt='100%'){
        $_this =& get_instance();
        $data = '<img class ="lazy '.$class.'" src="'.$_this->templates_assets.'images/dot.jpg" data-src="'.getImageThumb($image,$width,$height,$crop,$qlt).'" alt="'.$alt.'"/>' ;
        echo $data;
    }
}
