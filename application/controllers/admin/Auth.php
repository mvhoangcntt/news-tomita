...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (!$this->ion_auth->logged_in())
        {
            ...
            redirect(BASE_ADMIN_URL.'auth/login', 'refresh');
        }
        ...
        if($this->input->server('REQUEST_METHOD') == 'POST'){
            ...
            if ($this->form_validation->run() === TRUE)
            {
                ...
                if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
                {
                    ...
                    $this->session->set_userdata("user", $this->input->post('identity'));
                    //redirect them back to the home page
                    $url_redirect = $this->input->get('url') ? urldecode(trim($this->input->get('url'))) : BASE_ADMIN_URL;
                ...
                else
                {
                    ...
                    $this->session->set_flashdata('message', $message);
                    redirect(BASE_ADMIN_URL.'auth/login', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
                }
            }
    ...
    public function forgot_password()
    {
        ...
        else
        {
            ...
            {
                $this->session->set_flashdata('message', $this->ion_auth->errors());
                redirect(BASE_ADMIN_URL."auth/forgot_password", 'refresh');
            }
        }
    }
    ...
    public function create_user()
    {
        ...
        $this->form_validation->set_rules('username', $this->lang->line('create_user_validation_identity_label'), 'trim|required|is_unique[' . $tables['users'] . '.username]');
        $this->form_validation->set_rules('email', $this->lang->line('create_user_validation_email_label'), 'trim|required|valid_email|is_unique[' . $tables['users'] . '.email]');
