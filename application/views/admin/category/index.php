						...
						<div class="tab-pane" id="tab_info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input name="class" placeholder="Class icon" class="form-control" type="text" />
								</div>
								<div class="form-group">
									<label>Link</label>
								...
								<?php if(!empty($category_type) && !in_array($category_type,array('tags'))): ?>
									<div class="form-group">
										...
										<div class="input-group input-group-lg">
											<span class="input-group-addon" onclick="chooseImage('banner')"><i class="fa fa-fw fa-image"></i><?php echo lang('btn_select_image');?></span>
											<input id="banner" onclick="chooseImage('banner')" name="banner" placeholder="banner" class="form-control" type="text"/>
