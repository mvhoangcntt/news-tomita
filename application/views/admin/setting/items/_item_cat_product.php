            ...
            <?php foreach ($this->config->item('cms_language') as $lang_code => $lang_name) { ?>
                <div class="tab-pane <?php echo ($lang_code == 'vi') ? 'active' : ''; ?>"
                    ...
                    <fieldset style="width: 100%" class="">
                        ...
                        <div class="col-md-4">
                            <textarea name="<?php echo $meta_key; ?>[<?php echo $meta_key . $id; ?>][<?php echo $lang_code ?>][desc]" id="" cols="30" rows="4" class="form-control" placeholder="mô tả"></textarea>
                        </div>
                        <div class="col-md-2">
                            <input
                                id="<?php echo $meta_key; ?>_<?php echo $lang_code.$i; ?>"
                                ...
                                style="width: 50%"/>
                            <img onclick="chooseImage('<?php echo $meta_key; ?>_<?php echo $lang_code.$i; ?>')"
