<div class="tab-pane active" id="tab_general">
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="input-group input-group-lg">
                                        <span class="input-group-addon" onclick="chooseImage('logo_footer')"
                                              data-toggle="tooltip" title="<?php echo lang('btn_select_image'); ?>"><i
                                              class="fa fa-fw fa-image"></i></span>
        <input id="logo_footer" name="logo_footer" value="<?php echo isset($logo_footer) ? $logo_footer : ''; ?>"
               placeholder="Logo Home" class="form-control"
               type="text"/>
        <span class="input-group-addon"><a class="fancybox"
    ...
    <div class="form-group">
      <label>Logo Page</label>
      <div class="input-group input-group-lg">
                                        <span class="input-group-addon" onclick="chooseImage('logo_page')"
                                              data-toggle="tooltip" title="<?php echo lang('btn_select_image'); ?>"><i
                                              class="fa fa-fw fa-image"></i></span>
        <input id="logo_page" name="logo_page"
               value="<?php echo isset($logo_page) ? $logo_page : ''; ?>"
               placeholder="Logo Page"
               class="form-control" type="text"/>
        <span class="input-group-addon"><a class="fancybox"
                                           href="<?php echo getImageThumb(isset($logo_page) ? $logo_page : '') ?>"
                                           title="Click để xem ảnh"> <img
