                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_info">
                            <div class="box-body">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="displayed_time" placeholder="Ngày đăng tin"
                                ...
                                <div class="col-sm-6 col-xs-12 tuyendung_">
                                    <fieldset>
                                        <legend>Nội dung Tuyển dụng</legend>
                                        <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="salary" placeholder="Mức lương" class="form-control"
                                                   type="text"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Số lượng: </label>
                                            <input name="number" placeholder="Số lượng" class="form-control"
                                                   type="text"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Thời gian làm việc: </label>
                                            <input name="time" placeholder="Thời gian làm việc" class="form-control"
                                                   type="text"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Ngày hết hạn nộp hồ sơ</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-calendar"></i>
                                                </div>
                                                <input name="expiration_time" placeholder="Ngày hết hạn nộp hồ sơ"
