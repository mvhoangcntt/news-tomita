                                                ...
                                                if(!empty($controllers)):
                                                    foreach($controllers as $controller):
                                                        ...
                                                        <tr id="per_<?php echo $name;?>">
                                                            ...
                                                            <td class="text-center">
                                                                <input type="checkbox" id="per_<?php echo $name;?>_import" name="permission[<?php echo $name;?>][import]"  value="1" />
                                                            </td>
                                                            <td class="text-center">
                                                                <input type="checkbox" id="per_<?php echo $name;?>_export" name="permission[<?php echo $name;?>][export]"  value="1" />
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    endforeach;
