        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div class="prf-content">
                    ...
                    <form class="prf-setting" id="profile_account" action="javascript:;">
                        <div class="prf-box">
                            <div class="avatar">
                                <div class="img">
                                ...
                                <div class="text">
                                    ...
                                    <label class="change-avata">
                                        <input type="file" id="avatar" accept="image/x-png,image/gif,image/jpeg"><?php echo lang('editAvatar') ?></label>
                                    </div>
                                </div>
                            ...
                            <div class="ctrl">
                                <button class="submit smooth updateProfile"><?php echo lang('save_change') ?></button>
                            </div>
                        </form>
                    </div>
                </div>
