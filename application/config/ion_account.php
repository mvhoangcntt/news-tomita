...
$config['tables']['users_groups']    = 'account_groups';
 ...
 */
$config['site_title']                 = "Apecsoft";       // Site Title, example.com
$config['admin_email']                = "noreplyapec@gmail.com"; // Admin Email, admin@example.com
...
$config['identity_alt']               = 'username';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
$config['identity_phone']         = 'phone';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
$config['min_password_length']        = 6;                   // Minimum Required Length of Password
$config['max_password_length']        = 32;                  // Maximum Allowed Length of Password
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'account/email/';
...
$config['message_start_delimiter'] = '<p class="text-success" style="margin-top: 10px">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="text-danger" style="margin-top: 10px">';		// Error message start delimiter
