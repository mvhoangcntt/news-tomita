...
$config['cms_language_role']['post']   = 'E-Catalog';
...
$config['cms_language_role']['showroom']      = 'Showroom';
$config['cms_language_role']['users']      = 'Thành viên';
$config['cms_language_role']['transport'] = 'Vận chuyển';
$config['cms_language_role']['Product'] = 'Đơn hàng';
$config['cms_language_role']['voucher'] = 'Voucher';
