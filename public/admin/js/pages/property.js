...
function loadFeature(dataSelected) {
    let selector = $('select.feature');
    selector.select2({
        allowClear: true,
        data: dataSelected,
        multiple: true,
        ajax: {
            url: base_url + 'admin/property/ajax_load/feature',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
...
function loadRectifi(dataSelected) {
    let selector = $('select.rectifi');
    selector.select2({
        allowClear: true,
        data: dataSelected,
        ajax: {
            url: base_url + 'admin/property/ajax_load/rectifi',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
...
function loadAppli(dataSelected) {
    let selector = $('select.appli');
    selector.select2({
        allowClear: true,
        data: dataSelected,
        ajax: {
            url: base_url + 'admin/property/ajax_load/appli',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
...
function loadTech(dataSelected) {
    let selector = $('select.tech');
    selector.select2({
        allowClear: true,
        data: dataSelected,
        ajax: {
            url: base_url + 'admin/property/ajax_load/tech',
            dataType: 'json',
            delay: 250,
            processResults: function (data) {
                return {
