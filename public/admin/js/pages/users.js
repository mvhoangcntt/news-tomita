    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.type === "warning") {
                ...
                $('[name="repassword"]').val(null);
                $('[name="username"]').val(data.user.username).attr('readonly',true);
                $('[name="email"]').val(data.user.email).attr('readonly',true);
                ...
                toastr[data.message.type](data.message.message);
            }
        }
    });
}
